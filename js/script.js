// JavaScript Document
    ...
    async function handleNetlifySubmit(event) {
      ...
      // Reset styling
      nameInput.style.border = '2px solid var(--light-gray)';
      emailInput.style.border = '2px solid var(--light-gray)';
      messageInput.style.border = '2px solid var(--light-gray)';
      formMessage.textContent = '';
      formMessage.className = 'form-message';
      ...
      if (messageInput.value.trim() === '') {
        messageInput.style.border = '2px solid #dc3545';
